...
case "$file" in
  */internal/signer/*|*/internal/payload/*|*/internal/whitelist/*|*/internal/evmcall/*|*/internal/mcp/*|*/internal/agent/guard/*|*/internal/agent/hitl/*|*/internal/agent/writepath/*|*/internal/agent/chainid/*)
