        ...
        <nav class="sidebar-nav">
          ...
          >
            <span class="nav-icon" aria-hidden="true">
              ...
              <svg v-else-if="item.icon === 'agents'" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75">
              ...
              <svg v-else-if="item.icon === 'delegations'" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75">
                <rect x="3" y="3" width="7" height="7" rx="1.5" />
                <rect x="14" y="14" width="7" height="7" rx="1.5" />
                <path d="M10 6.5h5.5A2.5 2.5 0 0 1 18 9v2M14 17.5H8.5A2.5 2.5 0 0 1 6 15v-2" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
