...
//
// Each line is one JSON Run with run_id, steps, outcome (success|failed|stopped|rejected|cancelled),
// and tx_hashes extracted from broadcast tool results. Private keys and API keys are redacted.
//
