...
Reference file for the `lendora-lending` skill, loaded on demand via `read_skill_reference`. Contains detailed error
response templates by category — pick the matching row and adapt the numbers.
