...
// older releases lack runtime stubs required by the current Go toolchain and fail to compile.
require (
...
replace (
	...
	cosmossdk.io/store => github.com/deltaping/cosmos-sdk/store v1.0.3-0.20260526234433-5f3ec252bccc
	...
	github.com/cosmos/cosmos-sdk => github.com/deltaping/cosmos-sdk v0.50.6-0.20260126162345-69ba38d4ae69
	github.com/cosmos/evm => github.com/deltaping/evm v1.0.0-rc2.0.20260414142633-8d28e31fb1fc
