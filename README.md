...
Import a key → **Settings** (language, chain id, LLM API key; expand **LLM** and **Skills** as needed) → optional **Security** whitelist → use **Assistant** for on-chain actions, or export **MCP** config for Cursor.
...
| [Graphical app (svpchain-gui)](docs/gui.md) | Tabs, assistant & LLM settings, assistant skills |
